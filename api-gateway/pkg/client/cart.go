...
func NewCartClient(cfg *config.Config) (interfaces.CartClient, error) {
...
func (c *cartClient) AddToCart(ctx context.Context, userID, productItemId uint64) error {

	_, err := c.client.AddToCart(ctx, &pb.AddToCartRequest{UserId: userID, ProductId: productItemId})
